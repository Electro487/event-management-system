    ...
    <div class="main-content">
        <div class="content-header" style="margin-bottom: 30px; display: flex; align-items: center; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
            <div style="display: flex; flex-direction: column; gap: 5px;">
                <a href="/EventManagementSystem/public/admin/requests" style="display:inline-block; text-decoration:none; color:var(--primary-color); font-weight: 600; font-size: 14px; margin-bottom: 5px;"><i class="fa-solid fa-arrow-left"></i> Back to Requests</a>
