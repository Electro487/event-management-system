...
<head>
    ...
    <title>All System Bookings - Admin Panel</title>
    ...
    <main class="main-content">
        <header class="content-header b-header">
            <div class="header-left b-header-left">
                ...
                <p>Global oversight of all client reservations and payments</p>
            </div>
        ...
        <div class="filters-row">
            <div class="search-wrap bottom-search">
                <i class="fas fa-search"></i>
                <input type="text" id="filterSearchInput" placeholder="Filter by client, event or organizer...">
            </div>
