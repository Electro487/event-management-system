...
<head>
    ...
    <title><?php echo $title ?? 'Custom Requests - Admin Panel'; ?></title>
                    ...
                    <div class="booking-card">
                        ...
                        <div class="booking-details">
                            ...
                            <div class="card-actions">
                                <a href="/EventManagementSystem/public/admin/requests/view?id=<?php echo $request['id']; ?>" class="btn-secondary">Manage Request</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
