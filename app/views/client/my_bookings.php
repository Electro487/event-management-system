...
<head>
    ...
    <link rel="stylesheet" href="/EventManagementSystem/public/assets/css/booking.css"> <!-- Base styles (navbar etc) -->
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="page-header-row clearfix">
            <a href="/EventManagementSystem/public/client/events" class="btn-browse-more">Browse More Events <i class="fa-solid fa-arrow-right"></i></a>
            <div class="headings">
        ...
        <div class="filter-tabs">
            <div class="filter-tab active" onclick="filterBookings('all', this)">All <span><?php echo $totalBookings; ?></span></div>
