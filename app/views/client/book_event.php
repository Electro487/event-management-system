    ...
    <div class="container">
        ...
        <?php if(isset($_GET['success'])): ?>
            ...
            <div class="confirmation-box">
                ...
                <p>Your booking request for has been successfully received. Our concierges will review it and contact you shortly to finalize the arrangements.</p>
                <div class="conf-details">
                    <span>Booking Reference ID:</span>
                    <strong>#EPLN-<?php echo str_pad($_GET['booking_id'], 5, '0', STR_PAD_LEFT); ?></strong>
                </div>
                <a href="/EventManagementSystem/public/client/events#my-bookings" class="btn-primary" style="display:inline-block; margin-top:20px; text-decoration:none;">View My Bookings</a>
            </div>
            ...
            <form action="/EventManagementSystem/public/client/book/store" method="POST" class="booking-grid">
                ...
                <div class="left-col">
                    ...
                    <div class="form-section">
                        <h4><i class="fa-regular fa-calendar" style="color:#1f6f59; margin-right:8px;"></i> Event Details</h4>
                    ...
                    <!-- Personal Info Box -->
                    <div class="form-section">
                        <h4><i class="fa-regular fa-user" style="color:#1f6f59; margin-right:8px;"></i> Personal Information</h4>
                ...
                <div class="right-col">
                    <div class="order-summary">
                        ...
                        <div class="whats-included">
                            ...
                            <ul class="wi-list">
                                <?php foreach($items as $item): ?>
                                    <li><i class="fa-regular fa-circle-check" style="color:#1f6f59;"></i> <?php echo htmlspecialchars($item['title']); ?></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        ...
                        <p class="terms-text">By clicking confirm, you agree to e-Plan's Terms of Service and Privacy Policy.</p>
                    </div>
                </div>
