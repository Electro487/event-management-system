...
<body>
    ...
    <header class="header">
        ...
        <nav class="nav-links">
            ...
            <a href="/EventManagementSystem/public/client/bookings"
                class="<?php echo (strtolower($eventCategory) !== 'concert') ? 'active' : ''; ?>">My Bookings</a>
            <a href="/EventManagementSystem/public/client/tickets"
                class="<?php echo (strtolower($eventCategory) === 'concert') ? 'active' : ''; ?>">My Tickets</a>
