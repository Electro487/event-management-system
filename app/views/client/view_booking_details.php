        ...
        <div class="content-grid">
            ...
            <div class="right-col">
                ...
                <div class="summary-box">
                    ...
                    $hasAnyAdvancePaid = (isset($paidAdvance) && $paidAdvance > 0.009);
                    $isAdvanceComplete = (isset($remainingAdvance) && $remainingAdvance <= 0.009);
                    ...
                    <div class="price-row">
                        ...
                        <span style="color: <?php echo ($isAdvanceComplete || $isFullyPaid) ? '#10b981' : '#64748b'; ?>; font-weight: 600;">
                            Rs. <?php echo isset($paidAdvance) ? number_format($paidAdvance, 2) : '0.00'; ?> / <?php echo number_format($advance, 2); ?>
