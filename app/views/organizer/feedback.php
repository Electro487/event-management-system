...
<body>
    <?php
    $activePage = 'feedback';
    include dirname(__DIR__) . '/organizer/partials/sidebar.php';
    ?>
    ...
    <main class="main-content">
        <header class="header">
            ...
            <div class="header-icons">
                ...
                <?php include dirname(__DIR__) . '/organizer/partials/header_profile.php'; ?>
            </div>
        </header>
        ...
        <div class="np-hero">
            ...
            <div class="np-hero-right">
                <div class="np-hero-badge">
                    ...
                    <span><?php echo $stats['total']; ?> Reviews Received</span>
                </div>
            </div>
        </div>
        ...
        <div class="np-filter-bar">
            <a href="/EventManagementSystem/public/organizer/feedback"
                class="np-filter-tab <?php echo ($activeRating === 'all') ? 'active' : ''; ?>">
                <i class="fa-solid fa-border-all"></i> All
                <span class="np-filter-count"><?php echo $stats['total']; ?></span>
            </a>
            <?php for ($i = 5; $i >= 1; $i--): ?>
                <a href="/EventManagementSystem/public/organizer/feedback?rating=<?php echo $i; ?>"
        ...
        <div class="feedback-grid">
            <?php foreach ($feedbacks as $fb): ?>
                <div class="feedback-card">
                    ...
                    <!-- Main Reply Button (Organizer side) -->
