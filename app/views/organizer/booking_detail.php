                ...
                <div class="card <?php echo (!$hasButtons) ? 'card-status-empty' : ''; ?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php if($status !== 'cancelled' && $pStat === 'partially_paid'): ?>
                            <form action="/EventManagementSystem/public/organizer/bookings/mark-paid" method="POST"
                ...
                <div class="card">
                    ...
                    <div class="policy-note" style="margin-top:15px; padding:10px; background:#f8fafc; border-radius:8px; border:1px dashed #cbd5e1;">
                        <span style="font-size:11px; color:#64748b; display:block; line-height:1.4;">
                            <i class="fa-solid fa-circle-info"></i> <b>Policy:</b> Advanced payments are non-refundable upon cancellation. Balance is to be collected in cash on the event day.
                        </span>
                    </div>
                </div>
