    ...
    <main class="main-content">
            ...
            <div class="header-right b-header-right">
                ...
                <div class="header-actions">
                    ...
                    <div class="user-profile-info">
                        <div class="up-text">
                            <span class="up-name"><?php echo $_SESSION['user_fullname'] ?? 'Admin'; ?></span>
                            <span class="up-role">Website Owner</span>
                        </div>
        ...
        <div class="stats-row">
            <div class="stat-box">
                ...
                <h2 class="stat-number dark"><?php echo $totalBookings; ?></h2>
            </div>
            <div class="stat-box">
                <p class="stat-title">Confirmed</p>
                <h2 class="stat-number green"><?php echo $confirmedCount; ?></h2>
            </div>
            <div class="stat-box">
                <p class="stat-title">Pending</p>
                <h2 class="stat-number orange"><?php echo $pendingCount; ?></h2>
            </div>
            <div class="stat-box">
                <p class="stat-title">Cancelled</p>
                <h2 class="stat-number red"><?php echo $cancelledCount; ?></h2>
            </div>
        </div>
            ...
            <div class="pagination-row">
                <div class="showing-text">
                    Showing <span id="visibleCount"><?php echo count($bookings); ?></span> of <span
                        id="totalBookingsSpan"><?php echo $totalBookings; ?></span> bookings
                </div>
